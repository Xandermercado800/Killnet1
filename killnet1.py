...
def check(myip, prox, url):
        try:
                ...
                if ipx == myip:
                        ...
                        print(Fore.WHITE+Back.BLACK+"{} good proxy".format(prox)+Style.RESET_ALL)
...
╚═══>\033[95m """)
        ...
        if proxy == None:
                while True:
                        ...
                        req9 = r.get("https://raw.githubusercontent.com/ZOXXX906/japan_ddoser/main/https.txt").text
                        req10 = r.get("https://raw.githubusercontent.com/ZOXXX906/japan_ddoser/main/http.txt").text
